...
import BlogImage1 from "../asset/blogImage1.jpg";
import BlogImage2 from "../asset/blogImage2.jpg";
import BlogImage3 from "../asset/blogImage3.jpg";
  ...
  return (
    <div className="blogs-container">
      <div className="container-blogs">
        <div className="title-container-blogs">
          <Title title="Blogs" lineCenter={true} />
